    ...
    withHandlers(
        {
            ...
            submit: props => event => {
                ...
                props.dispatch(actions.editTour(props.state.toursInput));
            },
                ...
                <div className="filters-wrapper">
                    ...
                    <Row>
                        <Col sm={12} md={4} lg={4}>
                            ...
                            <img style={{width: '100%'}} src={ImageUploadService.getImageURL(props.state.toursInput.image.large)} />}
                        ...
                        <Col sm={12} md={8} lg={8}>
                            <div className="route-head">Change the Route for the Tour</div>
